...
new Database;
class SiteBlogSearchController extends Controller
{
    /**
     * @function index()
    ...
    public function index(){
        ...
        $widgets = Widget::all();
        $newsCount = News::where('content', 'like', $search)
            ->orWhere('title','like', $search)
            ->orWhere('description', 'like', $search)
            ->orWhere('author', 'like', $search)
            ->orderBy('id', 'desc')
            ->count('id');
        Blade::render('site/main/pages/blog_search', compact('newsCount', 'widgets', 'categories', 'search'));
    }
    /**
     * @function create()
     * View form create
    ...
    public function create(){
        ...
        $news = News::where('content', 'like', $search)
            ...
            ->orWhere('author', 'like', $search)
            ->orderBy('id', 'desc')
            ->skip($so_ban_ghi_bo_qua)
            ->limit($per_page)
            ->get();
        Blade::render('site/main/paginations/blog_search_pagination', compact('news', 'categories'));
    }
    /**
     * @function store()
