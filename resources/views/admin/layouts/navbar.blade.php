            ...
            <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false"><img style="border-radius: 50%" src="
                @if (App\Users::find($_SESSION['user']['id'])->image)
                        /superFood_MVC/backend/assets/images/{{App\Users::find($_SESSION['user']['id'])->image}}
                @else /superFood_MVC/backend/assets/images/user/defaultImage.png
                @endif
                        " alt="" width="30" height="30"></a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                <a class="dropdown-item"
                   href="/superFood_MVC/admin/userProfile/edit/@php echo $_SESSION['user']['id'] @endphp">Thông tin cá
                    nhân</a>
